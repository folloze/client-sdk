...
import {
    UploadUrlResponseV1, FormV1, ImageBankCategory, ImageGalleryTypes, GalleryImage,
...
export const rules = (mock: MockAdapter) => {
    ...
    // mock.onGet("/api/v1/image_gallery", {params: {type: "campaign"}})
    //     .reply<GalleryImage[]>(200, [
    //         {
    //             "fit": "cover",
    ...
    // //banners
    // mock.onGet("/api/v1/image_gallery", {params: {type: "image_bank", bank_category: 1, organization_id: 1}})
    //     .reply<GalleryImage[]>(200, [
    //         {
    //             fit: "cover",
    ...
    // //icons
    // mock.onGet("/api/v1/image_gallery", {params: {type: "image_bank", bank_category: 4, organization_id: 1}})
    //     .reply<GalleryImage[]>(200, [
    //         {
    ...
    // mock.onGet("/api/v1/image_gallery", {params: {type: "search", query: "bug"}})
    //     .reply<GalleryImage[]>(200, [
    //         {
