...
export const rules = (mock: MockAdapter) => {
    ...
    mock.onPost("/api/v1/image_gallery", {type: "campaign"})
    ...
    //banners
    mock.onPost("/api/v1/image_gallery", {type: "image_bank", bank_category: 1, organization_id: 1})
        .reply<GalleryImage[]>(200, [
            {
                fit: "cover",
    ...
    //icons
    mock.onPost("/api/v1/image_gallery", {type: "image_bank", bank_category: 4, organization_id: 1})
        .reply<GalleryImage[]>(200, [
            {
    ...
    mock.onPost("/api/v1/image_gallery", {type: "search", query: "bug"})
        .reply<GalleryImage[]>(200, [
            {
