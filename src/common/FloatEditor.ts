        ...
        return html`
            ...
            <div
                ...
                ${this.childEl.widget?.documentationUrl ?
                    html`<div class="documentation-url" @click=${this.goToDocumentation}>
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
