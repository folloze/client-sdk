...
export declare type VideoAIVoice = {
    id: string;
    name: string;
    gender: 'male' | 'female';
    provider: string;
...
export declare type VideoAIAvatar = {
    presenter_id: string;
    gender: 'male' | 'female';
    name: string;
    preview_url: string;
...
export declare type VideoAIGenerateRequest = {
    presenter_id: string;
    script: {
        type: "text";
        subtitles: boolean;
...
export declare type VideoAIGenerateResponse = {
    id: number;
    url: string;
