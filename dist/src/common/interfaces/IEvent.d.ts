...
export type PUBLIC_OUTGOING_EVENT_ACTION = "Folloze.ctaClick" | "Folloze.ctaSubmit" | "Folloze.pageview" | "Folloze.onConsent" | "Folloze.linkClick" | "Folloze.boardReady" | "Folloze.boardIdle";
...
export type FLZ_LIVEBOARD_EVENT_ACTION = "board-ready" | "board-idle" | "append-to-liveboard" | "append-to-liveboard-light-dom" | "widget-connected" | "widget-update" | "widget-updated" | "widget-first-updated" | "widgets-scripts-loaded" | "resize" | "change-category" | "changeItem" | "close-modal" | "closeItemViewerRequest" | "ctaClick" | "ctaSubmit" | "cookie-consent" | "get-current-item" | "get-initial-journey-item" | "get-category-slug" | "get-all-categories" | "get-modal-element" | "get-item" | "get-items" | "get-lead" | "get-journey" | "getFormData" | "get-form-privacy-message" | "close-form-request" | "get-contact-card-info" | "get-file-metadata" | "get-file-download-url" | "get-footers" | "get-org-header-config" | "stop-tracking-for-visit" | "like-item" | "open-link-by-target-type" | "openItemViewer" | "itemViewerClosed" | "item-viewer-new-item" | "open-modal" | "register-floating-widgets-triggers" | "get-form-privacy-messages" | "share-by-email" | "share-board" | "get-privacy-messages" | "get-state" | "is-personalization-mod" | "floating-widget-manager" | "track-lead-event" | "analytic-event" | "link-click" | "get-is-regulated-country" | "join-event" | "get-public-url" | "load-add-to-calendar" | "load-chat-script" | "create-chat-user" | "join-chat-conversation" | "leave-chat-conversation" | "track-live-event-attendance" | "get-live-event-participants" | "join-live-event" | "leave-live-event" | "scroll" | "get-open-zoom-urls";
