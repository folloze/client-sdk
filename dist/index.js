...
var MockConnector = class {
  static bindLiveBoard(mock) {
    import("./chunks/mocks.MDGAR2OI.js").then((module) => module.rules(mock)).catch((e5) => console.error("could not import liveboard mocks", e5));
  }
  static bindDesigner(mock) {
    import("./chunks/mocks.7SNOPGYK.js").then((module) => module.rules(mock)).catch((e5) => console.error("could not import designer mocks", e5));
  }
  static bindAnalytics(mock) {
    import("./chunks/mocks.Y7JJXNKE.js").then((module) => module.rules(mock)).catch((e5) => console.error("could not import analytics mocks", e5));
  }
};
...
LiveWidgetEdit = __decorateClass([
  n5("live-widget-edit")
], LiveWidgetEdit);
...
LiveWidgetComponentEdit = __decorateClass([
  n5("live-widget-comp-edit")
