...
var rules = (mock) => {
  ...
  mock.onGet(/prism\/(\d+)\/campaign_elements/, { params: { element_type: 1 /* footer */ } }).reply(200, {
    default_id: 0,
    data: {
      "0": {
  ...
  mock.onGet(/prism\/(\d+)\/campaign_elements/, { params: { element_type: 2 /* privacy_message */ } }).reply(200, {
    default_id: 0,
    data: {
      "0": {
        can_close: true,
  ...
  mock.onGet(/prism\/(\d+)\/campaign_elements/, { params: { element_type: 3 /* form_privacy_message */ } }).reply(200, {
    default_id: 0,
    data: {
      "0": {
